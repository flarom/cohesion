...
function getDefaultOpts (simple) {
  ...
  var defaultOptions = {
    ...
    imageTitleAsLegend: {
      defaultValue: false,
      describe: 'Appends a legend to images based on their title attribute',
      type: 'boolean'
    },
  };
  if (simple === false) {
...
showdown.subParser('makehtml.images', function (text, options, globals) {
  ...
  function writeImageTag (wholeMatch, altText, linkId, url, width, height, m5, title) {
    ...
    if (options.imageTitleAsLegend && titleForLegend) {
      var caption = String(titleForLegend)
        .replace(/&/g, '&amp;')
        .replace(/</g, '&lt;')
        .replace(/>/g, '&gt;');

      result = '<figure>' + result + '<figcaption>' + caption + '</figcaption></figure>';
    }
